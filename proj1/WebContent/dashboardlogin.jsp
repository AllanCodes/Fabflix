...
<div class = "mainContainer">
	...
	<div class = "centered">
		...
		<h5 class = "title2">Employee Login</h5>
		<div id = "loginForm">
			<div>
			...
			<br><br><br>
			<div>
				<form id="loginform" method="POST" action="_dashboard">
					<label id="userLabel">User</label>
				  	<input id="user" type="text" name="email" placeholder="Email">
				  	<label>Password</label>
				  	<input id="pass" type="password" name="password" placeholder="Password">
					<br><br>
					<input type="hidden" id="loginPost" name="loginPost" value="true" />
					<input id="submitbutton" type="submit" name="submit" value="Submit">
				</form>
			</div> 
		</div>
		<button id = "loginButton" onclick="displayLogin()">Login</button>
	</div>
</div>
